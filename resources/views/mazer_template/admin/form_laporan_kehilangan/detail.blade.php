...
@section('title', 'Detail Formulir Laporan Kehilangan')
@section('content')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Detail Formulir Laporan Kehilangan</h3>
            </div>
        </div>
    </div>
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            <div class="mb-4">
                ...
                <a type="button" class="btn btn-danger" id="cetak-pdf-form-laporanKehilangan" onClick="cetakPdfFormLaporanKehilangan()"><i class="bi bi-printer" style="font-size: 13px;"></i> Cetak Pdf</a>
            </div>
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="barang_hilang" class="form-control" value="{{ $data->barang_hilang }}" name="barang_hilang" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    function cetakPdfFormLaporanKehilangan() {
        var btn = document.getElementById('cetak-pdf-form-laporanKehilangan');
        ...
        setTimeout(function () {
            ...
            window.open('{{ route('admin.formlaporankehilangan.pdf',$data->id) }}', '_blank');
        }, 1000);
    }
