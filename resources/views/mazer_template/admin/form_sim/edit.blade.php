...
@section('title', 'Update Formulir Permohonan SIM')
@section('content')
...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Update Formulir Permohonan SIM</h3>
            </div>
        </div>
    </div>
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            ...
            <form class="form" action="{{ url('admin/formsim/update/'.$data->id) }}" id="form-update-sim" method="POST">
                @csrf
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="polda_kedatangan" class="form-control" placeholder="..." name="polda_kedatangan"
                                                value="{{ old('polda_kedatangan') ? old('polda_kedatangan') : $data->polda_kedatangan }}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="pendidikan_terakhir" class="form-control" placeholder="..." name="pendidikan_terakhir"
                                                value="{{ old('pendidikan_terakhir') ? old('pendidikan_terakhir') : $data->pendidikan_terakhir }}">
            ...
            <div class="d-grid gap-2 mt-4">
                <button class="btn btn-primary btn-lg" type="submit" id="submit-update-sim" onClick="changeToLoadingFormUpdateSim()">Submit</button>
            </div>
        </div>
    </section>
</div>
...
<script>
    function changeToLoadingFormUpdateSim() {
        var btn = document.getElementById('submit-update-sim');
    ...
    function submitFormUpdateSim() {
        ...
        var form = document.getElementById('form-update-sim');
