...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Update Formulir Laporan Kehilangan</h3>
            </div>
        </div>
    </div>
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            <div class="mb-4">
                <a href="{{ route('admin.formlaporankehilangan.index') }}" type="button" class="btn btn-primary"><i class="bi bi-arrow-return-left" style="font-size: 13px;"></i> Kembali</a>
            </div>
            <form class="form" action="{{ url('admin/formlaporankehilangan/update/'.$data->id) }}" id="form-update-laporanKehilangan" method="POST">
                @csrf
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="barang_hilang" class="form-control" placeholder="..." name="barang_hilang"
                                                value="{{ old('barang_hilang') ? old('barang_hilang') : $data->barang_hilang }}">
            ...
            <div class="d-grid gap-2 mt-4">
                <button class="btn btn-primary btn-lg" type="submit" id="submit-update-sidik-jari" onClick="changeToLoadingFormUpdateLaporanKehilangan()">Submit</button>
            </div>
        </div>
    </section>
</div>
...
<script>
    function changeToLoadingFormUpdateLaporanKehilangan() {
        ...
        setTimeout(function () {
            ...
            // Submit the form
            submitFormUpdateLaporanKehilangan();
        }, 2000);
    }

    function submitFormUpdateLaporanKehilangan() {
        // Get the form element
        var form = document.getElementById('form-update-laporanKehilangan');
