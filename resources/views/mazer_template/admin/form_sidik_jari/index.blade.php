...
@section('title', 'Daftar Formulir Pendaftaran Sidik Jari')
@section('content')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Formulir Pendaftaran Sidik Jari</h3>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive mt-4 mb-4" style="width: 100%;">
                    <table class="table table-striped table-bordered" id="form_sidik_jari" style="border-collapse: collapse; width: 100%; table-layout: fixed;">
                        <thead>
                            <tr>
